#!/usr/bin/env python3
"""
fix_app_intelligence.py
Backs up and overwrites the app_intelligence_app.py with a clean, validated implementation.
"""
...
TARGET_DIR = ROOT / "app_intelligence"
TARGET_DIR.mkdir(parents=True, exist_ok=True)
TARGET_FILE = TARGET_DIR / "app_intelligence_app.py"
BACKUP_DIR = ROOT / "patch_backups"
BACKUP_DIR.mkdir(parents=True, exist_ok=True)

NEW_APP_CODE = r'''from __future__ import annotations
import os
import sys
import logging
from pathlib import Path
...
# -------- App --------
app = FastAPI(title="THE13TH — App Intelligence", version="1.0.0")
app.add_middleware(
    CORSMiddleware,
...
if TARGET_FILE.exists():
    ...
    backup_path = BACKUP_DIR / f"{TARGET_FILE.name}.bak.{ts}"
    shutil.copy2(TARGET_FILE, backup_path)
    print("Backed up existing file to:", backup_path)

# write new file
TARGET_FILE.write_text(NEW_APP_CODE)
print("Wrote new app file to:", TARGET_FILE)
